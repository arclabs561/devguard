...
def get_ops_agent_path() -> Path | None:
    ...
    # Try to find ops/agent relative to guardian
    guardian_path = Path(__file__).parent.parent.parent
    ops_agent_path = guardian_path.parent / "ops" / "agent"
...
def get_ops_config_path() -> Path | None:
    ...
    guardian_path = Path(__file__).parent.parent.parent
    ops_config_path = guardian_path.parent / "ops" / "config"
...
def get_iam_posture_path() -> Path | None:
    ...
    """
    guardian_path = Path(__file__).parent.parent.parent
    iam_path = guardian_path.parent / "ops" / "security" / "iam-posture.yaml"
