...
class Settings(BaseSettings):
    ...
    email_thread_id_file: str | None = Field(
        None,
        description="Path to file storing last email thread ID (default: .guardian-email-thread)",
    )
    email_history_file: str | None = Field(
        None,
        description="Path to JSON file storing email history for agent introspection (default: .guardian-email-history.json)",
    )
