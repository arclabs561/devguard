...
class Reporter:
    ...
    def _print_report(self, report: GuardianReport) -> None:
        ...
        console.print("\n[bold blue]devguard Report[/bold blue]")
        ...
        if use_smart_email:
            try:
                ...
                alert_id = hashlib.sha256(
                    f"{topic}:{entry['timestamp']}:devguard".encode()
                ).hexdigest()[:12]
    ...
    def get_email_history(self, limit: int = 10) -> list[dict[str, Any]]:
        ...
        if use_smart_email:
            ...
            try:
                ...
                # Query alert_history for devguard emails (author='devguard')
                rows = conn.execute(
                    """
                ...
                # Convert to devguard history format with all preserved metadata
                history = []
                for row in rows:
                    (
                        topic_val,
            ...
            if llm_enabled:
                ...
                if llm_service:
                    ...
                    try:
                        ...
                        subject = f"devguard Security Report - {subject_suffix}"
                else:
                    subject_suffix = self._generate_subject(report)
                    subject = f"devguard Security Report - {subject_suffix}"
            else:
    ...
    async def _send_via_smart_email(
        ...
        try:
            ...
            success = smart_send_alert(
                ...
                topic=topic,
                severity=severity,
                headline=f"devguard Security Report - {headline}",
                message=message,
                author="devguard",
...
<body>
    <div class="container">
        <div class="header">
            <h1>devguard Security Report</h1>
        ...
        <div class="footer">
            Generated by devguard Security Monitoring System
        </div>
    </div>
</body>
</html>"""
